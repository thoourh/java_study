...
import dev.thoourh.community.jpa.entity.BoardEntity;
import dev.thoourh.community.jpa.entity.PostEntity;
import dev.thoourh.community.jpa.entity.UserEntity;
import dev.thoourh.community.model.PostDto;
import dev.thoourh.community.repository.BoardRepository;
import dev.thoourh.community.repository.PostRepository;
import dev.thoourh.community.repository.UserRepository;
...
public class JpaPostService implements PostService{
    ...
    @Override
    public PostDto read(Long board, Long postId) {
